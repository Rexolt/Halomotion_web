...
export const CustomCursor = () => {
  ...
  return (
    <>
      ...
      <div 
        ref={cursorDot} 
        className="fixed top-0 left-0 w-2 h-2 bg-white rounded-full pointer-events-none mix-blend-exclusion z-[99999]"
      />
      {/* Külső Kör */}
      <div 
        ref={cursorOutline} 
        className="fixed top-0 left-0 w-10 h-10 border border-white/60 rounded-full pointer-events-none mix-blend-exclusion z-[99999]"
      />
    </>
  );
};