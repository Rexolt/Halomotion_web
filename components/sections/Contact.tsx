...
export const Contact = () => {
  ...
  return (
    <section id="contact" className="relative py-32 px-6 md:px-20 bg-halo-black border-t border-white/10">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
        <div>
          <h2 className="font-display text-6xl md:text-8xl leading-none tracking-tighter text-white mb-8">
